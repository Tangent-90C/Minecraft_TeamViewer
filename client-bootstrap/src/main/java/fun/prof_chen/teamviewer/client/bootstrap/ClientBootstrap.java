package fun.prof_chen.teamviewer.client.bootstrap;
...
/** Loader-neutral Java 17 bootstrap shared by Fabric and NeoForge entrypoints. */
public final class ClientBootstrap {
    ...
    public static synchronized void start() {
        if (application != null) {
            throw new IllegalStateException("TeamViewRelay client bootstrap already started");
        }
    ...
    private static <W, H> ClientApplication<W, H> start(ClientAdapterFactory<W, H> factory) {
        ...
        ClientApplication<W, H> started = ClientApplication.start(adapters);
