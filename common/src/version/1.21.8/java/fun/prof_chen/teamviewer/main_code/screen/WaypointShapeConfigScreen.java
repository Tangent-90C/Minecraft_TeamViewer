...
public class WaypointShapeConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.waypointBeamWidthField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_width")
        );
        this.waypointBeamWidthField.setText(String.valueOf(PlayerProcesses.getConfig().getWaypointBeaconBeamWidth()));
        this.waypointBeamWidthField.setMaxLength(10);
        this.waypointBeamWidthField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_width_hint"));
        this.addDrawableChild(this.waypointBeamWidthField);

        this.addDrawableChild(
            new TextWidget(leftX, firstRowY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_width"), this.textRenderer)
                .alignLeft()
        ...
        this.waypointBeamHeightField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_height")
        );
        this.waypointBeamHeightField.setText(String.valueOf(PlayerProcesses.getConfig().getWaypointBeaconBeamHeight()));
        this.waypointBeamHeightField.setMaxLength(10);
        this.waypointBeamHeightField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_height_hint"));
        this.addDrawableChild(this.waypointBeamHeightField);

        this.addDrawableChild(
            new TextWidget(rightX, firstRowY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.waypoint_beacon_beam_height"), this.textRenderer)
                .alignLeft()
                .setTextColor(0xFFFFFF)
        );
        ...
        this.tmBeamWidthField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_width")
        );
        this.tmBeamWidthField.setText(String.valueOf(PlayerProcesses.getConfig().getTampermonkeyBeamWidth()));
        this.tmBeamWidthField.setMaxLength(10);
        this.tmBeamWidthField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_width_hint"));
        this.addDrawableChild(this.tmBeamWidthField);

        this.addDrawableChild(
            new TextWidget(leftX, secondRowY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_width"), this.textRenderer)
                .alignLeft()
                .setTextColor(0xFFFFFF)
        );
        ...
        this.tmBeamHeightField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_height")
        );
        this.tmBeamHeightField.setText(String.valueOf(PlayerProcesses.getConfig().getTampermonkeyBeamHeight()));
        this.tmBeamHeightField.setMaxLength(10);
        this.tmBeamHeightField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_height_hint"));
        this.addDrawableChild(this.tmBeamHeightField);

        this.addDrawableChild(
            new TextWidget(rightX, secondRowY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.tampermonkey_beam_height"), this.textRenderer)
                .alignLeft()
                .setTextColor(0xFFFFFF)
        );
    ...
    private void applyFieldValues() {
        try {
            ...
            if (!waypointBeamWidthStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setWaypointBeaconBeamWidth(waypointBeamWidth);
            }
            ...
            if (!waypointBeamHeightStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setWaypointBeaconBeamHeight(waypointBeamHeight);
            }
            ...
            if (!tmBeamWidthStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setTampermonkeyBeamWidth(tmBeamWidth);
            }
            ...
            if (!tmBeamHeightStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setTampermonkeyBeamHeight(tmBeamHeight);
            }
