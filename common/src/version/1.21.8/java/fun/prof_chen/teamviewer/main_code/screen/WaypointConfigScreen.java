...
public class WaypointConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.waypointTimeoutField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.waypoint_timeout")
        );
        this.waypointTimeoutField.setText(String.valueOf(PlayerProcesses.getConfig().getWaypointTimeoutSeconds()));
        this.waypointTimeoutField.setMaxLength(10);
        this.waypointTimeoutField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.waypoint_timeout_hint"));
        this.addDrawableChild(this.waypointTimeoutField);

        this.addDrawableChild(
            new TextWidget(leftX, firstFieldY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.waypoint_timeout"), this.textRenderer)
                .alignLeft()
        ...
        this.longTermWaypointTimeoutField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.long_term_waypoint_timeout")
        );
        this.longTermWaypointTimeoutField.setText(String.valueOf(PlayerProcesses.getConfig().getLongTermWaypointTimeoutSeconds()));
        this.longTermWaypointTimeoutField.setMaxLength(10);
        this.longTermWaypointTimeoutField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.long_term_waypoint_timeout_hint"));
        ...
        this.addDrawableChild(
            new TextWidget(rightX, firstFieldY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.long_term_waypoint_timeout"), this.textRenderer)
                .alignLeft()
                .setTextColor(0xFFFFFF)
        );
        ...
        this.quickMarkMaxCountField = new TextFieldWidget(
            ...
            COMPONENT_WIDTH,
            COMPONENT_HEIGHT,
            Text.translatable("screen.mc_teamviewer.config.quick_mark_max_count")
        );
        this.quickMarkMaxCountField.setText(String.valueOf(PlayerProcesses.getConfig().getMaxQuickMarkCount()));
        this.quickMarkMaxCountField.setMaxLength(10);
        this.quickMarkMaxCountField.setPlaceholder(Text.translatable("screen.mc_teamviewer.config.quick_mark_max_count_hint"));
        this.addDrawableChild(this.quickMarkMaxCountField);

        this.addDrawableChild(
            new TextWidget(leftX, secondFieldY - LABEL_SPACING, COMPONENT_WIDTH, 12,
                Text.translatable("screen.mc_teamviewer.config.quick_mark_max_count"), this.textRenderer)
                .alignLeft()
                .setTextColor(0xFFFFFF)
        );

        this.waypointUiStyleButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.waypoint_ui_style"),
        ...
        this.showSharedWaypointsButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.show_shared_waypoints"),
        ...
        this.showOwnSharedWaypointsOnMinimapButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.show_own_shared_waypoints_on_minimap"),
        ...
        this.middleDoubleClickMarkButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.middle_double_click_mark"),
        ...
        this.middleClickCancelWaypointButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.middle_click_cancel_waypoint"),
        ...
        this.enableLongTermWaypointButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.enable_long_term_waypoint"),
        ...
        this.autoCancelWaypointOnEntityDeathButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.auto_cancel_waypoint_on_entity_death"),
        ...
        this.waypointShapeSettingsButton = ButtonWidget.builder(
            Text.translatable("screen.mc_teamviewer.config.waypoint_shape_settings"),
    ...
    private void toggleShowSharedWaypoints() {
        boolean currentStatus = PlayerProcesses.getConfig().isShowSharedWaypoints();
        PlayerProcesses.getConfig().setShowSharedWaypoints(!currentStatus);
        updateShowSharedWaypointsButton();
    }

    private void updateShowSharedWaypointsButton() {
        if (this.showSharedWaypointsButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isShowSharedWaypoints();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.show_shared_waypoints").getString();
    ...
    private void toggleShowOwnSharedWaypointsOnMinimap() {
        boolean currentStatus = PlayerProcesses.getConfig().isShowOwnSharedWaypointsOnMinimap();
        PlayerProcesses.getConfig().setShowOwnSharedWaypointsOnMinimap(!currentStatus);
        updateShowOwnSharedWaypointsOnMinimapButton();
    }

    private void updateShowOwnSharedWaypointsOnMinimapButton() {
        if (this.showOwnSharedWaypointsOnMinimapButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isShowOwnSharedWaypointsOnMinimap();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.show_own_shared_waypoints_on_minimap").getString();
            buttonText += isEnabled ? " [ON]" : " [OFF]";
    ...
    private void toggleMiddleDoubleClickMark() {
        boolean currentStatus = PlayerProcesses.getConfig().isEnableMiddleDoubleClickMark();
        PlayerProcesses.getConfig().setEnableMiddleDoubleClickMark(!currentStatus);
        updateMiddleDoubleClickMarkButton();
    }

    private void updateMiddleDoubleClickMarkButton() {
        if (this.middleDoubleClickMarkButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isEnableMiddleDoubleClickMark();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.middle_double_click_mark").getString();
            buttonText += isEnabled ? " [ON]" : " [OFF]";
    ...
    private void toggleMiddleClickCancelWaypoint() {
        boolean currentStatus = PlayerProcesses.getConfig().isEnableMiddleClickCancelWaypoint();
        PlayerProcesses.getConfig().setEnableMiddleClickCancelWaypoint(!currentStatus);
        updateMiddleClickCancelWaypointButton();
    }

    private void updateMiddleClickCancelWaypointButton() {
        if (this.middleClickCancelWaypointButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isEnableMiddleClickCancelWaypoint();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.middle_click_cancel_waypoint").getString();
            buttonText += isEnabled ? " [ON]" : " [OFF]";
    ...
    private void toggleAutoCancelWaypointOnEntityDeath() {
        boolean currentStatus = PlayerProcesses.getConfig().isAutoCancelWaypointOnEntityDeath();
        PlayerProcesses.getConfig().setAutoCancelWaypointOnEntityDeath(!currentStatus);
        updateAutoCancelWaypointOnEntityDeathButton();
    }

    private void updateAutoCancelWaypointOnEntityDeathButton() {
        if (this.autoCancelWaypointOnEntityDeathButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isAutoCancelWaypointOnEntityDeath();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.auto_cancel_waypoint_on_entity_death").getString();
            buttonText += isEnabled ? " [ON]" : " [OFF]";
    ...
    private void toggleEnableLongTermWaypoint() {
        boolean currentStatus = PlayerProcesses.getConfig().isEnableLongTermWaypoint();
        PlayerProcesses.getConfig().setEnableLongTermWaypoint(!currentStatus);
        updateEnableLongTermWaypointButton();
    }

    private void updateEnableLongTermWaypointButton() {
        if (this.enableLongTermWaypointButton != null) {
            boolean isEnabled = PlayerProcesses.getConfig().isEnableLongTermWaypoint();
            String buttonText = Text.translatable("screen.mc_teamviewer.config.enable_long_term_waypoint").getString();
            buttonText += isEnabled ? " [ON]" : " [OFF]";
    ...
    private void applyFieldValues() {
        try {
            ...
            if (!waypointTimeoutStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setWaypointTimeoutSeconds(waypointTimeout);
            }
            ...
            if (!longTermWaypointTimeoutStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setLongTermWaypointTimeoutSeconds(longTermWaypointTimeout);
            }
            ...
            if (!quickMarkMaxCountStr.isEmpty()) {
                ...
                PlayerProcesses.getConfig().setMaxQuickMarkCount(quickMarkMaxCount);
            }
