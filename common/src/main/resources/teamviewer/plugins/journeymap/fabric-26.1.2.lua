...
tv.register_remote_player_projection({id = "journeymap-players", kind = "JOURNEYMAP_MAP_MARKER", probe = probe,
...
tv.register_remote_player_projection({id = "journeymap-player-beacons", kind = "JOURNEYMAP_BEACON", probe = probe,
