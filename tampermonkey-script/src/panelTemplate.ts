export const PANEL_HTML = `
  ...
  <div class="n-page active" id="nodemc-overlay-page-main">
    ...
    <div class="n-btns">
      ...
      <button id="nodemc-overlay-open-connection" type="button" class="n-link-btn">连接设置</button>
      <button id="nodemc-overlay-open-display" type="button" class="n-link-btn">显示设置</button>
  ...
  <div class="n-page" id="nodemc-overlay-page-advanced">
    ...
    <!-- 连接相关设置已移至 二级菜单: 连接设置 (connection) -->
    ...
    <label class="n-check"><input id="nodemc-overlay-show-horse-text" type="checkbox" />显示马文字信息</label>
  ...
  <div class="n-page" id="nodemc-overlay-page-display">
    <div class="n-nav-row">
      <div class="n-subtitle" style="margin:0;">显示设置</div>
      <button id="nodemc-overlay-back-main-from-display" type="button" class="n-link-btn">返回基础设置</button>
    </div>
    ...
    <div class="n-btns">
      <button id="nodemc-overlay-save-display" type="button">保存显示设置</button>
    </div>
  </div>

  <div class="n-page" id="nodemc-overlay-page-connection">
    <div class="n-nav-row">
      <div class="n-subtitle" style="margin:0;">连接设置</div>
      <button id="nodemc-overlay-back-main-from-connection" type="button" class="n-link-btn">返回基础设置</button>
    </div>
    <div class="n-row">
    ...
    <div class="n-btns">
      <button id="nodemc-overlay-save-connection" type="button">保存连接设置</button>
