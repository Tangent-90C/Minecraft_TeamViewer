...
public final class ConfigScreen extends Screen {
    ...
    private void activate(ConfigControlId id) {
        ...
        switch (action.type()) {
            ...
            case OPEN_PAGE -> MinecraftClientUiCompat.setScreen(
                    minecraft, new ConfigScreen(this, session, action.targetPage()));
            case OPEN_PLUGIN_MANAGER -> MinecraftClientUiCompat.setScreen(
                    minecraft, new PluginManagerScreen(this, session.plugins()));
