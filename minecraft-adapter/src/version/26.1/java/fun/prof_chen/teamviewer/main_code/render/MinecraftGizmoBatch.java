...
/** Loader-neutral Minecraft 26.x conversion from common commands to batched Gizmos. */
public final class MinecraftGizmoBatch {
    private MinecraftGizmoBatch() { }

    public static void render(WorldRenderFrame frame) {
