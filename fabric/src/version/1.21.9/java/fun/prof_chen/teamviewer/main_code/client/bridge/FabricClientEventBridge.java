...
public final class FabricClientEventBridge implements ClientEventBridge<FabricWorldRenderContext, DrawContext> {
    ...
    @Override
    public void register(ClientEventHandler<FabricWorldRenderContext, DrawContext> handler) {
