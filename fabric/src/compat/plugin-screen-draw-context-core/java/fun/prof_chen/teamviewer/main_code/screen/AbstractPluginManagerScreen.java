...
/** Plugin manager host for the Fabric 1.20.1-1.21.8 DrawContext family. */
abstract class AbstractPluginManagerScreen extends Screen {
    ...
    protected final boolean scroll(double mouseX, double mouseY, double verticalAmount) {
    ...
    private static Text toText(UiText value) {
        ...
        MutableText text = value.translationKey() == null
                ...
                : Text.translatable(value.translationKey(),
                        value.arguments().stream().map(AbstractPluginManagerScreen::toText).toArray());
