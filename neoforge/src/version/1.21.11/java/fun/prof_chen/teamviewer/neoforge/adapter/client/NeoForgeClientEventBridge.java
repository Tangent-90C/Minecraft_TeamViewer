...
public final class NeoForgeClientEventBridge
        implements ClientEventBridge<ExtractLevelRenderStateEvent, GuiGraphics> {
    ...
    @Override
    public void register(ClientEventHandler<ExtractLevelRenderStateEvent, GuiGraphics> handler) {
    ...
    private void onEndTick(ClientEventHandler<ExtractLevelRenderStateEvent, GuiGraphics> handler) {
