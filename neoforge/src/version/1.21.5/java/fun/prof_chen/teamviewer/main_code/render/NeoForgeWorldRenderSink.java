...
public final class NeoForgeWorldRenderSink implements WorldRenderSink<RenderLevelStageEvent> {
    ...
    private static RenderType createNoDepthLines() {
        RenderPipeline pipeline = RenderPipeline.builder(RenderPipelines.MATRICES_SNIPPET)
                ...
                .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.DEBUG_LINE_STRIP).build();
