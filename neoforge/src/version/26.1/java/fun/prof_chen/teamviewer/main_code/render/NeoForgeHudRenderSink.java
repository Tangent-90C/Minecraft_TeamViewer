...
public final class NeoForgeHudRenderSink implements HudRenderSink<GuiGraphicsExtractor> {
    @Override
    ...
    private static Component toComponent(UiText value) {
        MutableComponent component = value.translationKey() == null
                ...
                : Component.translatable(value.translationKey(), value.arguments().stream().map(NeoForgeHudRenderSink::toComponent).toArray());
